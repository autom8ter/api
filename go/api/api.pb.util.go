...
func (o *Auth0) OAuthConfig() *oauth2.Config {
	return auth0.NewOauth2Config(o.ClientId, o.ClientSecret, o.Domain, o.Redirect, o.Scopes...)
}
...
func (o *Auth0) HandleOAuthCallback(loggedInPath string) http.HandlerFunc {
	return callback.HandleOAuthCallback(o.OAuthConfig(), AUTH_SESSION_NAME, auth0.UserInfoEndpoint(o.Domain), loggedInPath)
}
...
func (o *Auth0) HandleOAuthLogout(returnTo string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		u, err := auth0.LogoutEndpoint(o.ClientId, o.Domain, returnTo)
		if err != nil {
			http.Error(w, err.Error(), http.StatusInternalServerError)
			return
		}
...
func (o *Auth0) GetUserInfo(r *http.Request) (*UserInfo, error) {
	obj, err := sessions2.GetResourceFromSession(auth0.UserInfoEndpoint(o.Domain), AUTH_SESSION_NAME, r)
...
func (a *Auth0) Auth0Middleware(resourceURL string) *jwtmiddleware.JWTMiddleware {
	return jwtmiddleware.New(jwtmiddleware.Options{
		ValidationKeyGetter: func(token *jwt.Token) (interface{}, error) {
			...
			cert, err := auth0.GetPemCert(a.Domain, token)
			if err != nil {
				return "", err
			}
...
func (o *Auth0) TokenHasScope(scope string, token string) bool {
	return jwt2.TokenHasScope(scope, token)
}

func (o *Auth0) TokenHasAudience(scope string, token string) bool {
	return jwt2.TokenHasAudience(scope, token)
}
