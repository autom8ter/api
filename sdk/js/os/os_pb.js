...
goog.exportSymbol('proto.os.FileSystem', null, global);
 ...
 * @constructor
 */
proto.os.FileSystem = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.os.FileSystem, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.os.FileSystem.displayName = 'proto.os.FileSystem';
}
 ...
 * @return {!Object}
 */
proto.os.FileSystem.prototype.toObject = function(opt_includeInstance) {
  return proto.os.FileSystem.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.os.FileSystem} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.os.FileSystem.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.os.FileSystem}
 */
proto.os.FileSystem.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.os.FileSystem;
  return proto.os.FileSystem.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.os.FileSystem} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.os.FileSystem}
 */
proto.os.FileSystem.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.os.FileSystem.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.os.FileSystem.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.os.FileSystem} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.os.FileSystem.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.os.FileSystem.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.os.FileSystem.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.os.FileSystem.prototype.getOsType = function() {
  return /** @type {!proto.os.OSType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.os.OSType} value */
proto.os.FileSystem.prototype.setOsType = function(value) {
