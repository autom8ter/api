...
/**
 * optional common.Message message = 3;
 * @return {?proto.common.Message}
 */
proto.api.SMS.prototype.getMessage = function() {
  return /** @type{?proto.common.Message} */ (
    jspb.Message.getWrapperField(this, common_common_pb.Message, 3));
};


/** @param {?proto.common.Message|undefined} value */
...
proto.api.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    password: (f = msg.getPassword()) && common_common_pb.Password.toObject(includeInstance, f),
...
proto.api.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 20:
      ...
      break;
    case 21:
      var value = new common_common_pb.Password;
      reader.readMessage(value,common_common_pb.Password.deserializeBinaryFromReader);
...
proto.api.User.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      21,
      f,
      common_common_pb.Password.serializeBinaryToWriter
    );
  }
...
/**
 * optional common.Password password = 21;
 * @return {?proto.common.Password}
 */
proto.api.User.prototype.getPassword = function() {
  return /** @type{?proto.common.Password} */ (
    jspb.Message.getWrapperField(this, common_common_pb.Password, 21));
};


/** @param {?proto.common.Password|undefined} value */
...
proto.api.RenderRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    template: (f = msg.getTemplate()) && common_common_pb.Template.toObject(includeInstance, f),
...
proto.api.RenderRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new common_common_pb.Template;
      reader.readMessage(value,common_common_pb.Template.deserializeBinaryFromReader);
...
proto.api.RenderRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      common_common_pb.Template.serializeBinaryToWriter
    );
  }
  f = message.getData();
  if (f != null) {
...
/**
 * optional common.Template template = 1;
 * @return {?proto.common.Template}
 */
proto.api.RenderRequest.prototype.getTemplate = function() {
  return /** @type{?proto.common.Template} */ (
    jspb.Message.getWrapperField(this, common_common_pb.Template, 1));
};


/** @param {?proto.common.Template|undefined} value */
...
proto.api.TokenQuery.toObject = function(includeInstance, msg) {
  var f, obj = {
    token: (f = msg.getToken()) && common_common_pb.Token.toObject(includeInstance, f),
    query: (f = msg.getQuery()) && common_common_pb.Query.toObject(includeInstance, f)
  };
