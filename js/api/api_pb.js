...
goog.exportSymbol('proto.api.UnImplemented', null, global);
 ...
 * @constructor
 */
proto.api.UnImplemented = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.UnImplemented, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.api.UnImplemented.displayName = 'proto.api.UnImplemented';
}
 ...
 * @return {!Object}
 */
proto.api.UnImplemented.prototype.toObject = function(opt_includeInstance) {
  return proto.api.UnImplemented.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.UnImplemented} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.UnImplemented.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.UnImplemented}
 */
proto.api.UnImplemented.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.UnImplemented;
  return proto.api.UnImplemented.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.UnImplemented} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.UnImplemented}
 */
proto.api.UnImplemented.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.UnImplemented.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.UnImplemented.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.UnImplemented} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.UnImplemented.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
