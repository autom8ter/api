  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "daysUntilDue",
        .dataTypeSpecific.className = GPBStringifySymbol(Int64),
        .number = SubscriptionResponse_FieldNumber_DaysUntilDue,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(SubscriptionResponse__storage_, daysUntilDue),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
...
typedef struct ConfigSet__storage_ {
  uint32_t _has_storage_[1];
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = ConfigSet_FieldNumber_Configs,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(ConfigSet__storage_, configs),
        .flags = GPBFieldMapKeyString,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ConfigSet class]
                                     rootClass:[ApiRoot class]
                                          file:ApiRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ConfigSet__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
