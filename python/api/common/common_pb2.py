...
_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='annotations', full_name='common.Event.annotations', index=0,
...
_EVENT.fields_by_name['annotations'].message_type = _STRINGMAP
